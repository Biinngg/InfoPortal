...
public class Result extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		if(FLOOR_NUM1 == 0) {
			...
			if(FLOOR_NUM1 != FLOOR_NUM2)
				str_floor = FLOOR_NUM1 +"层到" + FLOOR_NUM2 +"层,";
			else
				str_floor = FLOOR_NUM1 + "层";
		}
